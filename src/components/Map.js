...
export default class Map extends React.Component {
    ...
    getRank(label) {
        if(!this.props.scores) return 0;
        for (let z of this.props.scores) {
            if (z.label === label) return z.place;
        }
        return 0;
    }
                ...
                {this.state.zones.map(z => {
                    return (
                        <path id={z.label} d={z.d}
                              className={"rank-" + this.getRank(z.label) + " zone " + (this.props.page === "dash" ? "zoneLau " + z.color : "zoneHover")}
