    ...
    render() {
        return (
            ...
            <svg id="Zones" data-name="Zones" xmlns="http://www.w3.org/2000/svg"
                ...
                <path className="zone" id="ouest" onClick={() => this.onZoneClick(1)}  onMouseOut={() => this.mouseOut()} onMouseOver={() => this.mouseOver("ouest")}
                ...
                <path className="zone" id="est" onClick={() => this.onZoneClick(2)} onMouseOut={() => this.mouseOut()} onMouseOver={() => this.mouseOver("est")}
                ...
                <path className="zone" id="sud" onClick={() => this.onZoneClick(3)} onMouseOut={() => this.mouseOut()} onMouseOver={() => this.mouseOver("sud")}
                ...
                <path className="zone" id="nord" onClick={() => this.onZoneClick(4)} onMouseOut={() => this.mouseOut()} onMouseOver={() => this.mouseOver("nord")}
                ...
                <path className="zone" id="centre" onClick={() => this.onZoneClick(5)} onMouseOut={() => this.mouseOut()} onMouseOver={() => this.mouseOver("centre")}
